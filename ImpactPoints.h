...
// Wed Apr 24 16:31:44 2019 by ROOT version 6.10/05
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   /* ImpactPoints(char* fname, TChain *tree=0); */
...
/* ImpactPoints::ImpactPoints(char* fname, TChain *tree) : fChain(0)  */
ImpactPoints::ImpactPoints(TTree *tree) : fChain(0), newTr(0)
{
...
// used to generate this class and read the Tree.
   ...
   /*    } */
   /*    char dirName[300]; */
   /*    sprintf(dirName, "%s:/trackimpactntupler", fname); */
...
void ImpactPoints::SetNewTree(TTree* tr){
     newTr = tr;
     newTr->Branch("event", &event, "event/i");
     newTr->Branch("run", &run, "run/i");
     newTr->Branch("ntracks", &ntracks, "ntracks/I");
     newTr->Branch("impactX_HGCal_layer_1", &impactX_HGCal_layer_1, "impactX_HGCal_layer_1/F");
     newTr->Branch("impactY_HGCal_layer_1", &impactY_HGCal_layer_1, "impactY_HGCal_layer_1/F");
     newTr->Branch("impactX_HGCal_layer_2", &impactX_HGCal_layer_2, "impactX_HGCal_layer_2/F");
     newTr->Branch("impactY_HGCal_layer_2", &impactY_HGCal_layer_2, "impactY_HGCal_layer_2/F");
     newTr->Branch("impactX_HGCal_layer_3", &impactX_HGCal_layer_3, "impactX_HGCal_layer_3/F");
     newTr->Branch("impactY_HGCal_layer_3", &impactY_HGCal_layer_3, "impactY_HGCal_layer_3/F");
     newTr->Branch("impactX_HGCal_layer_4", &impactX_HGCal_layer_4, "impactX_HGCal_layer_4/F");
     newTr->Branch("impactY_HGCal_layer_4", &impactY_HGCal_layer_4, "impactY_HGCal_layer_4/F");
     newTr->Branch("impactX_HGCal_layer_5", &impactX_HGCal_layer_5, "impactX_HGCal_layer_5/F");
     newTr->Branch("impactY_HGCal_layer_5", &impactY_HGCal_layer_5, "impactY_HGCal_layer_5/F");
     newTr->Branch("impactX_HGCal_layer_6", &impactX_HGCal_layer_6, "impactX_HGCal_layer_6/F");
     newTr->Branch("impactY_HGCal_layer_6", &impactY_HGCal_layer_6, "impactY_HGCal_layer_6/F");
     newTr->Branch("impactX_HGCal_layer_7", &impactX_HGCal_layer_7, "impactX_HGCal_layer_7/F");
     newTr->Branch("impactY_HGCal_layer_7", &impactY_HGCal_layer_7, "impactY_HGCal_layer_7/F");
     newTr->Branch("impactX_HGCal_layer_8", &impactX_HGCal_layer_8, "impactX_HGCal_layer_8/F");
     newTr->Branch("impactY_HGCal_layer_8", &impactY_HGCal_layer_8, "impactY_HGCal_layer_8/F");
     newTr->Branch("impactX_HGCal_layer_9", &impactX_HGCal_layer_9, "impactX_HGCal_layer_9/F");
     newTr->Branch("impactY_HGCal_layer_9", &impactY_HGCal_layer_9, "impactY_HGCal_layer_9/F");
     newTr->Branch("impactX_HGCal_layer_10", &impactX_HGCal_layer_10, "impactX_HGCal_layer_10/F");
     newTr->Branch("impactY_HGCal_layer_10", &impactY_HGCal_layer_10, "impactY_HGCal_layer_10/F");
     newTr->Branch("impactX_HGCal_layer_11", &impactX_HGCal_layer_11, "impactX_HGCal_layer_11/F");
     newTr->Branch("impactY_HGCal_layer_11", &impactY_HGCal_layer_11, "impactY_HGCal_layer_11/F");
     newTr->Branch("impactX_HGCal_layer_12", &impactX_HGCal_layer_12, "impactX_HGCal_layer_12/F");
     newTr->Branch("impactY_HGCal_layer_12", &impactY_HGCal_layer_12, "impactY_HGCal_layer_12/F");
     newTr->Branch("impactX_HGCal_layer_13", &impactX_HGCal_layer_13, "impactX_HGCal_layer_13/F");
     newTr->Branch("impactY_HGCal_layer_13", &impactY_HGCal_layer_13, "impactY_HGCal_layer_13/F");
     newTr->Branch("impactX_HGCal_layer_14", &impactX_HGCal_layer_14, "impactX_HGCal_layer_14/F");
     newTr->Branch("impactY_HGCal_layer_14", &impactY_HGCal_layer_14, "impactY_HGCal_layer_14/F");
     newTr->Branch("impactX_HGCal_layer_15", &impactX_HGCal_layer_15, "impactX_HGCal_layer_15/F");
     newTr->Branch("impactY_HGCal_layer_15", &impactY_HGCal_layer_15, "impactY_HGCal_layer_15/F");
     newTr->Branch("impactX_HGCal_layer_16", &impactX_HGCal_layer_16, "impactX_HGCal_layer_16/F");
     newTr->Branch("impactY_HGCal_layer_16", &impactY_HGCal_layer_16, "impactY_HGCal_layer_16/F");
     newTr->Branch("impactX_HGCal_layer_17", &impactX_HGCal_layer_17, "impactX_HGCal_layer_17/F");
     newTr->Branch("impactY_HGCal_layer_17", &impactY_HGCal_layer_17, "impactY_HGCal_layer_17/F");
     newTr->Branch("impactX_HGCal_layer_18", &impactX_HGCal_layer_18, "impactX_HGCal_layer_18/F");
     newTr->Branch("impactY_HGCal_layer_18", &impactY_HGCal_layer_18, "impactY_HGCal_layer_18/F");
     newTr->Branch("impactX_HGCal_layer_19", &impactX_HGCal_layer_19, "impactX_HGCal_layer_19/F");
     newTr->Branch("impactY_HGCal_layer_19", &impactY_HGCal_layer_19, "impactY_HGCal_layer_19/F");
     newTr->Branch("impactX_HGCal_layer_20", &impactX_HGCal_layer_20, "impactX_HGCal_layer_20/F");
     newTr->Branch("impactY_HGCal_layer_20", &impactY_HGCal_layer_20, "impactY_HGCal_layer_20/F");
     newTr->Branch("impactX_HGCal_layer_21", &impactX_HGCal_layer_21, "impactX_HGCal_layer_21/F");
     newTr->Branch("impactY_HGCal_layer_21", &impactY_HGCal_layer_21, "impactY_HGCal_layer_21/F");
     newTr->Branch("impactX_HGCal_layer_22", &impactX_HGCal_layer_22, "impactX_HGCal_layer_22/F");
     newTr->Branch("impactY_HGCal_layer_22", &impactY_HGCal_layer_22, "impactY_HGCal_layer_22/F");
     newTr->Branch("impactX_HGCal_layer_23", &impactX_HGCal_layer_23, "impactX_HGCal_layer_23/F");
     newTr->Branch("impactY_HGCal_layer_23", &impactY_HGCal_layer_23, "impactY_HGCal_layer_23/F");
     newTr->Branch("impactX_HGCal_layer_24", &impactX_HGCal_layer_24, "impactX_HGCal_layer_24/F");
     newTr->Branch("impactY_HGCal_layer_24", &impactY_HGCal_layer_24, "impactY_HGCal_layer_24/F");
     newTr->Branch("impactX_HGCal_layer_25", &impactX_HGCal_layer_25, "impactX_HGCal_layer_25/F");
     newTr->Branch("impactY_HGCal_layer_25", &impactY_HGCal_layer_25, "impactY_HGCal_layer_25/F");
     newTr->Branch("impactX_HGCal_layer_26", &impactX_HGCal_layer_26, "impactX_HGCal_layer_26/F");
     newTr->Branch("impactY_HGCal_layer_26", &impactY_HGCal_layer_26, "impactY_HGCal_layer_26/F");
     newTr->Branch("impactX_HGCal_layer_27", &impactX_HGCal_layer_27, "impactX_HGCal_layer_27/F");
     newTr->Branch("impactY_HGCal_layer_27", &impactY_HGCal_layer_27, "impactY_HGCal_layer_27/F");
     newTr->Branch("impactX_HGCal_layer_28", &impactX_HGCal_layer_28, "impactX_HGCal_layer_28/F");
     newTr->Branch("impactY_HGCal_layer_28", &impactY_HGCal_layer_28, "impactY_HGCal_layer_28/F");
     newTr->Branch("impactX_HGCal_layer_29", &impactX_HGCal_layer_29, "impactX_HGCal_layer_29/F");
     newTr->Branch("impactY_HGCal_layer_29", &impactY_HGCal_layer_29, "impactY_HGCal_layer_29/F");
     newTr->Branch("impactX_HGCal_layer_30", &impactX_HGCal_layer_30, "impactX_HGCal_layer_30/F");
     newTr->Branch("impactY_HGCal_layer_30", &impactY_HGCal_layer_30, "impactY_HGCal_layer_30/F");
     newTr->Branch("impactX_HGCal_layer_31", &impactX_HGCal_layer_31, "impactX_HGCal_layer_31/F");
     newTr->Branch("impactY_HGCal_layer_31", &impactY_HGCal_layer_31, "impactY_HGCal_layer_31/F");
     newTr->Branch("impactX_HGCal_layer_32", &impactX_HGCal_layer_32, "impactX_HGCal_layer_32/F");
     newTr->Branch("impactY_HGCal_layer_32", &impactY_HGCal_layer_32, "impactY_HGCal_layer_32/F");
     newTr->Branch("impactX_HGCal_layer_33", &impactX_HGCal_layer_33, "impactX_HGCal_layer_33/F");
     newTr->Branch("impactY_HGCal_layer_33", &impactY_HGCal_layer_33, "impactY_HGCal_layer_33/F");
     newTr->Branch("impactX_HGCal_layer_34", &impactX_HGCal_layer_34, "impactX_HGCal_layer_34/F");
     newTr->Branch("impactY_HGCal_layer_34", &impactY_HGCal_layer_34, "impactY_HGCal_layer_34/F");
     newTr->Branch("impactX_HGCal_layer_35", &impactX_HGCal_layer_35, "impactX_HGCal_layer_35/F");
     newTr->Branch("impactY_HGCal_layer_35", &impactY_HGCal_layer_35, "impactY_HGCal_layer_35/F");
     newTr->Branch("impactX_HGCal_layer_36", &impactX_HGCal_layer_36, "impactX_HGCal_layer_36/F");
     newTr->Branch("impactY_HGCal_layer_36", &impactY_HGCal_layer_36, "impactY_HGCal_layer_36/F");
     newTr->Branch("impactX_HGCal_layer_37", &impactX_HGCal_layer_37, "impactX_HGCal_layer_37/F");
     newTr->Branch("impactY_HGCal_layer_37", &impactY_HGCal_layer_37, "impactY_HGCal_layer_37/F");
     newTr->Branch("impactX_HGCal_layer_38", &impactX_HGCal_layer_38, "impactX_HGCal_layer_38/F");
     newTr->Branch("impactY_HGCal_layer_38", &impactY_HGCal_layer_38, "impactY_HGCal_layer_38/F");
     newTr->Branch("impactX_HGCal_layer_39", &impactX_HGCal_layer_39, "impactX_HGCal_layer_39/F");
     newTr->Branch("impactY_HGCal_layer_39", &impactY_HGCal_layer_39, "impactY_HGCal_layer_39/F");
     newTr->Branch("impactX_HGCal_layer_40", &impactX_HGCal_layer_40, "impactX_HGCal_layer_40/F");
     newTr->Branch("impactY_HGCal_layer_40", &impactY_HGCal_layer_40, "impactY_HGCal_layer_40/F");
     newTr->Branch("trackChi2_X", &trackChi2_X, "trackChi2_X/F");
     newTr->Branch("trackChi2_Y", &trackChi2_Y, "trackChi2_Y/F");
     newTr->Branch("dwcReferenceType", &dwcReferenceType, "dwcReferenceType/I");
     newTr->Branch("m_x", &m_x, "m_x/D");
     newTr->Branch("m_y", &m_y, "m_y/D");
     newTr->Branch("b_x", &b_x, "b_x/D");
     newTr->Branch("b_y", &b_y, "b_y/D");
}
void ImpactPoints::FillNewTree(){
     newTr->Fill();
}
